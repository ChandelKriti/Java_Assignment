...
public class Date8Digit {
   
	    public String date8Digit( String date) throws IOException{
	    {   
	        ...
	        String date1 = date; //br.readLine(); //inputting the date in String format
	        ...
	        if(l==8) //performing the task only when number of digits is 8
	        {
	            ...
	            {
	            str = "The day, month or year are outside acceptable limit";
	            return str;
	            }
